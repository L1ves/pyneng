...
keys_name_deviceses = list(london_co[name_device].keys())
name_parameter =  input('Введите имя параметра: {}'.format(keys_name_deviceses))
print(london_co[name_device][name_parameter])
